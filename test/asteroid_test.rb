...
class AsteroidTest < MiniTest::Test
  def setup
    given_response = { links: { self: 'http://www.neowsapp.com/rest/v1/neo/3561029?api_key=dla9EfMtOkpcNWPis9lq3DWfQCtuRRfAdAxtFH4g' },
                       id: '3561029',
                       neo_reference_id: '3561029',
                       name: '(2011 GE3)',
                       nasa_jpl_url: 'http://ssd.jpl.nasa.gov/sbdb.cgi?sstr=3561029',
                       absolute_magnitude_h: 26.0,
                       estimated_diameter: { kilometers: { estimated_diameter_min: 0.0167708462, estimated_diameter_max: 0.0375007522 },
                       ...
                       close_approach_data: [{ close_approach_date: '2019-03-30',
                                               close_approach_date_full: '2019-Mar-30 05:04',
                                               epoch_date_close_approach: 1_553_922_240_000,
    ...
    @asteroid = Asteroid.new(given_response)
  end

  def test_it_has_the_desired_attributes
    assert_equal '(2011 GE3)', @asteroid.name
    assert_equal '35542652.814484172', @asteroid.miss_distance
    assert_equal 123.0339677816, @asteroid.estimated_diameter
  end
end
